...
4.
    ```rosbag record zed2/zed_node/depth/camera_info zed2/zed_node/rgb/camera_info zed2/zed_node/point_cloud/cloud_registered /robot/ee_pose_wrt_kinect /robot/ee_pose /robot/joint_angles /franka_state_controller/joint_states --split --duration=210```
