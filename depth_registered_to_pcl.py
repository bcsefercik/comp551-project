...
if __name__ == "__main__":
    ...
    input_folder = '/home/onurberk/Desktop/development/comp551-project/_gitignore/depth_registered_files/'
    input_file   = 'TEST_moving_001'
    input_ext    = '.pickle'
    input_full   = input_folder + input_file + input_ext
    input_file   = open(input_full,'rb')

    output_folder   = '/home/onurberk/Desktop/development/comp551-project/_gitignore/pcd_files/BG_TEST/'
    output_file     = 'BG'
    output_ext      = '.pcd'
